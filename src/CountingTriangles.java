...
public class CountingTriangles {
    ...
    int countDistinctTriangles(ArrayList<Sides> arrlist) {
        // Write your code here
        Set<String> sides = new HashSet<>();
        for(Sides arr : arrlist) {
            int[] side = new int[] {arr.a, arr.b, arr.c};
            Arrays.sort(side);  // constant time
            sides.add(side[0]+""+side[1]+""+side[2]);
        }
